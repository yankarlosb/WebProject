...
<template>
  <AppLayout>
    <div class="max-w-4xl mx-auto">
      ...
      <div v-if="authStore.mustChangePassword" class="mb-6 bg-red-50 border-l-4 border-red-500 p-4">
        <div class="flex">
          ...
          <div class="ml-3">
            <p class="text-sm text-red-700">
              <span class="font-bold">Atención:</span> Es necesario que cambies tu contraseña predeterminada por razones de seguridad.
            </p>
          </div>
        </div>
      </div>
...
async function handleChangePassword() {
  ...
  try {
    ...
    if (result.success) {
      ...
      resetPasswordForm()
      // Actualizar estado para desbloquear navegación inmediatamente
      authStore.updateUser({ must_change_password: false })
      
      // Forzar una reverificación del estado de autenticación (opcional pero recomendable)
